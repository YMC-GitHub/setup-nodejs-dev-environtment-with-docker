...
# cmd flow：
  ...
  setup env
    ./start.sh
  ls docker container image volume
    ./info.sh
  run some tasks
    ./task.sh
  stop,eixt..
  delete docker container image volume
    ./delete.sh
